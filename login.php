            ...
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    ...
                    <div class="col-md-8 col-10 my-5">
                        ...
                        <div class="row justify-content-center my-3 px-3"> <button class="btn-block btn-color" type="submit">Login to trips</button> </div>
                    </div>
                    <form>
                </div>
                <div class="bottom text-center mb-5">
                    <p class="sm-text mx-auto mb-3">Don't have an account?<a href="/taxa/registration.php" class="btn btn-white ml-2">Create new</a></p>
                </div>
            </div>
